...
const recaps = {
  ...
  2017: `
    ...
    <p>QB: I think I have the edge here with Bortles vs SF. Shaw has Cousins going against DEN. I can't believe I just typed those words, I can't quit Bortles</p>
    ...
    <p>1. Winner gets to change or add a rule that will improve the league in their mind. They can also remove a rule that a previous winner put in place. If the rule will significantly increase my time burden (see rule change #2 below) I may discuss other options with the winner. In the end if the winner is set on his/her suggestion I will comply.</p>
    ...
    <p>3. It is now ok to talk about Fight Club</p>
  ...
  2018: `
    ...
    <p>MATT YOU ALSO NEED TO PICK A NEW RULE FOR NEXT YEARS SEASON OR CHANGE A CURRENT RULE, sooner the better</p>

    <p>Well sadly that's it folks, until next year!!! Thanks for a great season and hopefully we'll see you all back for 2019</p>
  ...
  2021: `
    ...
    <p>Couldn't figure out how to upload the video but JD jerks off to it every night, he still sends me pictures</p>
  ...
  2024: `
    ...
    <p>High score is still up in the air for week 17 but it looks like Shaw-balls has a pretty sizable lead on that one, I'll wait to pay out until tomorrow just to be safe. That would be 4 high scores for Shaw and he basically played for free this year. Not a complete loss for the reigning champ.</p>

    <p>Debo and Gus got jack-shit, sorry fellas. Everybody else will be getting paid.</p>
